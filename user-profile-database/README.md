# Database Backend for the user-profile Application
The user-profile-backend application requires a persistent database backend. The user-profile-backend and the 
